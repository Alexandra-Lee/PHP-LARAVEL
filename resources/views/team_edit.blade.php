...
{!! Form::open(['action' => 'TeamsController@store', 'method' => 'POST']) !!}
    <div class="form-group">
        ...
        {{Form::text('name', '', ['class' => 'form-control', 'placeholder' => 'i.e. Les Revolutionaires'])}}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
            ...
            {{Form::text('goals', '', ['class' => 'form-control', 'placeholder' => 'Goals'])}}
    </div>
    <div class="form-group">
            {{Form::label('wins', 'Wins')}}
            {{Form::text('wins', '', ['class' => 'form-control', 'placeholder' => 'Wins'])}}
    </div>
    <div class="form-group">
